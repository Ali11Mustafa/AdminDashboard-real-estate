						...
						<Collapse isOpen={props.leftMenu} className="navbar-collapse" id="topnav-menu-content">
							<ul className="navbar-nav">
								...
								<li className="nav-item dropdown">
									...
									>
										<i className="ti-harddrives me-2" />
										{props.t('Components')}
									</Link>
								...
								<li className="nav-item dropdown mega-dropdown">
									...
									>
										<i className="ti-archive me-2" /> {props.t('Authentication')}
									</Link>
									<div
										className={classname(
								...
								<li className="nav-item dropdown">
									...
									>
										<i className="ti-support me-2" /> {props.t('Extra pages')}
									</Link>
								...
								<li className="nav-item dropdown">
									...
									>
										<i className="ti-bookmark-alt me-2" />
